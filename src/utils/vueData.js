export default [
  {
    id: '1001',
    title: 'setup语法糖与setup函数的区别',
    desc: 'setup语法糖与setup函数的区别：expose()函数（暴露属性）使用不同',
    readCount: 5,
...
2.直接配置数组
  export default{
    ...
    id: '1002',
    title: 'vue3父子组件的生命周期调用顺序（组合式）。',
    desc: 'vue3中父子组件的生命周期调用顺序及其他回调钩子的调用时机。',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `<div id="vn-container">
...
<span class='vn-color-blue'>如何解决：</span>在父nexttick中嵌套一层setTimeout微任务，延迟到子组件渲染完成后操作。
  ...
  },
  {
    id: '1005',
    title: 'js获取标签的css样式',
    desc: 'js获取标签的css样式：getComputedStyle(Node)',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
    <div id="vn-container">
  ...
  {
    id: '1006',
    title: 'input输入框中文合成事件',
    desc: '输入框在输入中文时，每个字母的输入都会触发input事件，解决办法可以用输入框的合成事件',
    readCount: 0,
    createTime: '20223-011-01 20:00:00',
    html: `
<div id="vn-container">
<code><"input 
@input="inputChange" 
...
<span class='vn-color-blue'>compositionend:</span>合成结束时，触发search并允许input触发search事件
  ...
  },
  {
    id: '1007',
    title: '浏览器指纹',
    desc: '在不需要用户登录情况下判定用户身份，原理是不同的浏览器/电脑做相同的事会产生不同的值，详细使用：Fingerprint.js',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: ``,
  },
  {
    id: '1008',
    title: '字符串匹配时不能带有()[]{}',
    desc: '在使用search，macth字符串匹配时匹配字符中带有()[]{}时会出错',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container">
...
// 会报错
  ...
  },
  {
    id: '1009',
    title: 'parseInt的使用',
    desc: 'parseInt(params1,params2):params1:转换的值；params2:转换的进制：2，8，10，16',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container">
...
故结果为：1，NaN，NaN
  ...
  {
    id: '1010',
    title: '标签通信:Broadcastchannel()',
    desc: 'const channel = Broadcastchannel("标签名")',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
 <div id="vn-container">
...
channel.onmessage = (e)=>{
  ...
  {
    id: '1011',
    title: '访问(用户选择)文件夹：showDirectoryPicker();访问(用户选择)文件：showOpenFilePicker',
    desc: '实现文件夹的读取：1.选择文件夹；2.获取文件夹内容；（异步迭代器）3.使文件目录结构可读；4.获取每个文件',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
    <div id="vn-container">
...
paralleTask(tasks, 3);</code></div>
    ...
    id: '1014',
    title: 'vue中watch及watchEffect(单依赖时推荐，若会使用到多个ref时不推荐)',
    desc: 'vue中watch及watchEffect的使用及区别',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container">
...
unwatch()</code></div>`
    ...
    id: '1015',
    title: '对象的属性描述符：Object.getOwnPropertyDescriptor(obj,property)',
    desc: '认识对象的属性描述符：Object.getOwnPropertyDescriptor及如何修改:Object.defineProperty()',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container">
...
Object.defineProperty(obj,'a',{
  ...
  {
    id: '1016',
    title: 'vue中提供自定义ref：customRef',
    desc: '使用v-model的同时利用customRef实现输入框的防抖',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container">
...
function debounceRef(value,delay=1000){
  ...
  */
  ...
  {
    id: '1017',
    title: 'Ajax请求上传/响应的进度监控',
    desc: 'Ajax请求上传/响应的进度监控：xhr：progress事件、fetch实现响应监听：利用文档读取事件实现;(fetch无法实现上传监听)：',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
...
while(1){
  ...
  {
    id: '1018',
    title: '判断两个变量的值是否一致：Object.is(a,b)',
    desc: '判断两个变量的值是否一致：Object.is(a,b)，解释函数形参的赋值问题',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container">
...
changeName(user)
console.log(user.name) // 小明</code></div>`
  },
  {
    id: '1019',
    title: '字符串的码元与码点',
    desc: '操作字符串的方法是通过操作码元实现的，但使用码元处理’双码元字符‘时会出现位置或乱码错误',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container"> 
...
String.prototype.sliceByPoint = function(sIndex,eIndex){
  ...
  {
    id: '1020',
    title: '为什么众多库里面都使用void 0 代替 undefined',
    desc: 'undefined在js中不是关键字，undefined在非全局域里面可以被当作变量声明',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
<div id="vn-container">
<code>if(1){
  ...
  {
    id: '1021',
    title: 'console的多种函数使用方法',
    desc: '不要只会用console.log()！建议多看此内容',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
...
console.error(); // 打印错误</code>
  ...
  {
    id: '1022',
    title: '游离结点造成的内存泄露：浏览器不会回收最后一次聚焦过的结点',
    desc: '浏览器不会回收最后一次聚焦过的结点，如果最后聚焦的是一个富文本占用较大内存，在失焦后应创建一个input聚焦来解决此问题',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
  ...
  {
    id: '1023',
    title: '将es6中的class类还原为es5语法（只包括属性和方法）',
    desc: '将es6中的class类还原为es5语法（只包括属性和方法）',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
...
console.log(p2.totalPrice)</code>
  ...
  {
    id: '1024',
    title: 'vue菜单组件修改二级菜单样式不生效',
    desc: 'vue中样式不生效，可以使用深度选择器: deep() | /deep/',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
...
.el-sub-menu <span class="vn-color-blue">:deep(.el-sub-menu__title)</span>  {
  ...
  {
    id: '1025',
    title: 'vue中改变组件key值，重新渲染某个组件',
    desc: 'vue中改变组件key值，重新渲染某个组件',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
...
&lt;HtmlToText :key="new Date().getTime()+'htmlText'"></code>
  ...
  },
  {
    ...
    desc: 'MutationObserver是一个JavaScript的API，用于监测DOM树的变化。它提供了一种异步的方式来监听DOM元素的增加、删除、属性变化等操作，以及文本节点的修改。通过MutationObserver，开发者可以实时地捕捉到DOM的变化，并做出相应的响应。',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
...
onUnmounted(()=>{
  ...
  {
    id: '1027',
    title: '元素相交监听：new IntersectionObserver()',
    desc: '监听两个结点相交：IntersectionObserver是异步的',
    readCount: 0,
    createTime: '20223-06-02 20:00:00',
    html: `
      <div id="vn-container">
