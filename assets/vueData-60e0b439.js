...
</code></div>`},{id:"1003",title:"自定义组件想可以使用provide(),inject()，可以实现上下级组件的数据共享",desc:'上级组件使用provide("count",count),下级组件使用const count = inject("count"),新版可以使用defineModel获取到组件传的v-model的值了',readCount:0,createTime:"20223-06-02 20:00:00",html:""},{id:"1004",title:"git忽略文件大小写规则",desc:"git忽略文件大小写规则：git config core.ignorecase false",readCount:0,createTime:"20223-06-02 20:00:00",html:""},{id:"1005",title:"js获取标签的css样式",desc:"js获取标签的css样式：getComputedStyle(Node)",readCount:0,createTime:"20223-06-02 20:00:00",html:`
    <div id="vn-container">
...
<h3>4.<span class="vn-color-blue">更多详情方法<a contenteditable="false" href="https://cn.vitejs.dev/guide/assets#explicit-url-imports" target="_blank">vite静态资源处理</a></span></h3>
      ...
      </div>`},{id:"1032",title:"",desc:"",readCount:0,createTime:"20223-06-02 20:00:00",html:`
      <div id="vn-container">
<pre><code>
</code></pre>
      </div>`},{id:"1033",title:"git 常用命令",desc:"",readCount:0,createTime:"20223-06-02 20:00:00",html:`
      <div id="vn-container">
<pre><code>
添加远程仓库地址：
